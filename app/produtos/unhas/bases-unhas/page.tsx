...
export const metadata: Metadata = pageMeta.basesUnhas;

export default function BasesUnhasPage() {
  return <TechnicalRoutineLanding config={getInnovationLandingConfig("basesUnhas")} />;
}
