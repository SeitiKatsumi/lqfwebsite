...
export const wordpressPages = [
  ...
  { slug: "produtos", label: "Inovações", url: "/produtos", title: pageMeta.produtos.title, description: pageMeta.produtos.description },
  { slug: "escudo-expossoma", label: "Escudo Expossoma", url: "/produtos/facial/expossoma", title: pageMeta.escudoExpossoma.title, description: pageMeta.escudoExpossoma.description },
  { slug: "cremes-cuidados-especiais", label: "Cremes Cuidados Especiais", url: "/produtos/facial/cremes-cuidados-especiais", title: pageMeta.cremesCuidadosEspeciais.title, description: pageMeta.cremesCuidadosEspeciais.description },
  { slug: "higienizacao-pele", label: "Produtos para Higienizar a Pele", url: "/produtos/facial/higienizacao-pele", title: pageMeta.higienizacaoPele.title, description: pageMeta.higienizacaoPele.description },
  { slug: "geleias-faciais-coloridas", label: "Geleias Faciais Coloridas", url: "/produtos/facial/geleias-faciais-coloridas", title: pageMeta.geleiasFaciaisColoridas.title, description: pageMeta.geleiasFaciaisColoridas.description },
  { slug: "make-performance", label: "Linha Make Performance", url: "/produtos/facial/make-performance", title: pageMeta.makePerformance.title, description: pageMeta.makePerformance.description },
  { slug: "sensitive-balance", label: "Sensitive Balance", url: "/produtos/facial/sensitive-balance", title: pageMeta.sensitiveBalance.title, description: pageMeta.sensitiveBalance.description },
  { slug: "seruns-ciclo-completo", label: "Séruns Ciclo Completo", url: "/produtos/facial/seruns-ciclo-completo", title: pageMeta.serunsCicloCompleto.title, description: pageMeta.serunsCicloCompleto.description },
  { slug: "skinimalismo", label: "Skinimalismo", url: "/produtos/facial/skinimalismo", title: pageMeta.skinimalismo.title, description: pageMeta.skinimalismo.description },
  { slug: "skincare-pele-acneica", label: "Skincare Pele Acneica", url: "/produtos/facial/skincare-pele-acneica", title: pageMeta.skincarePeleAcneica.title, description: pageMeta.skincarePeleAcneica.description },
  { slug: "skincare-pele-madura", label: "Skincare Pele Madura", url: "/produtos/facial/skincare-pele-madura", title: pageMeta.skincarePeleMadura.title, description: pageMeta.skincarePeleMadura.description },
  { slug: "linha-capilar-coreana", label: "Linha Capilar Coreana", url: "/produtos/capilar/linha-capilar-coreana", title: pageMeta.linhaCapilarCoreana.title, description: pageMeta.linhaCapilarCoreana.description },
  { slug: "capilar-cuidados-especiais", label: "Cuidados Especiais Capilares", url: "/produtos/capilar/cuidados-especiais", title: pageMeta.capilarCuidadosEspeciais.title, description: pageMeta.capilarCuidadosEspeciais.description },
  { slug: "linha-capilar-frutada", label: "Linha Capilar Frutada", url: "/produtos/capilar/linha-capilar-frutada", title: pageMeta.linhaCapilarFrutada.title, description: pageMeta.linhaCapilarFrutada.description },
  { slug: "capilar-recuperacao-tecnologica", label: "Capilar Recuperação Tecnológica", url: "/produtos/capilar/recuperacao-tecnologica", title: pageMeta.capilarRecuperacaoTecnologica.title, description: pageMeta.capilarRecuperacaoTecnologica.description },
  { slug: "capilar-variada", label: "Capilar Variada", url: "/produtos/capilar/variada", title: pageMeta.capilarVariada.title, description: pageMeta.capilarVariada.description },
  { slug: "mascaras-capilares", label: "Máscaras Capilares", url: "/produtos/capilar/mascaras-capilares", title: pageMeta.mascarasCapilares.title, description: pageMeta.mascarasCapilares.description },
  { slug: "oleos-capilares", label: "Óleos Capilares", url: "/produtos/capilar/oleos-capilares", title: pageMeta.oleosCapilares.title, description: pageMeta.oleosCapilares.description },
  { slug: "perfumes-capilares", label: "Perfumes Capilares", url: "/produtos/capilar/perfumes-capilares", title: pageMeta.perfumesCapilares.title, description: pageMeta.perfumesCapilares.description },
  { slug: "tonicos-capilares", label: "Tônicos Capilares", url: "/produtos/capilar/tonicos-capilares", title: pageMeta.tonicosCapilares.title, description: pageMeta.tonicosCapilares.description },
  { slug: "essencial-infantil", label: "Essencial Infantil", url: "/produtos/bebe-e-infantil/essencial-infantil", title: pageMeta.essencialInfantil.title, description: pageMeta.essencialInfantil.description },
  { slug: "enxaguantes-bucais", label: "Enxaguantes Bucais", url: "/produtos/bucal/enxaguantes-bucais", title: pageMeta.enxaguantesBucais.title, description: pageMeta.enxaguantesBucais.description },
  { slug: "cuidados-unhas-cuticulas", label: "Cuidados para Unhas e Cutículas", url: "/produtos/unhas/cuidados-unhas-cuticulas", title: pageMeta.cuidadosUnhasCuticulas.title, description: pageMeta.cuidadosUnhasCuticulas.description },
  { slug: "bases-unhas", label: "Bases para Unhas", url: "/produtos/unhas/bases-unhas", title: pageMeta.basesUnhas.title, description: pageMeta.basesUnhas.description },
